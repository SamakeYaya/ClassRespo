				...
				<div class="topbar-menu-area">
					<div class="container">
						...
						<div class="topbar-menu right-menu">
							<ul>
								<li class="menu-item" ><a title="Register or Login" href="login.php">Login</a></li>
								<li class="menu-item" ><a title="Register or Login" href="register.php">Register</a></li>								
					...
					<div class="wrap-shop-control">
						...
						<div class="wrap-right">
							...
							<div class="change-display-mode">
								...
								<a href="list.php" class="list-mode display-mode"><i class="fa fa-th-list"></i>List</a>
							</div>
								...
								<li class="product-item">
									<div class="product product-widget-style">
										<div class="thumbnnail">
											<a href="detail.php" title="Radiant-360 R6 Wireless Omnidirectional Speaker [White]">
