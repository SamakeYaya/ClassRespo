						...
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu">
								<li class="menu-item home-icon">
									<a href="pages/" class="link-term mercado-item-title"><i class="fa fa-home" aria-hidden="true"></i></a>
								</li>
								<li class="menu-item">
									<a href="about-us.php" class="link-term mercado-item-title">About Us</a>
								</li>
								<li class="menu-item">
									<a href="shop.php" class="link-term mercado-item-title">Shop</a>
								</li>
								<li class="menu-item">
									<a href="cart.php" class="link-term mercado-item-title">Cart</a>
								</li>
								<li class="menu-item">
					...
					<div class=" main-content-area">
						<div class="wrap-login-item ">
							<div class="register-form form-item ">
								<form class="form-stl" name="frm-login" method="post" id="registration_form">
									<fieldset class="wrap-title">
										<h3 class="form-title">Create an account</h3>
										<!-- <h4 class="form-subtitle" id="msg">Personal infomation</h4> -->
										<div id="msg">
									...
									<fieldset class="wrap-input">
										<label for="frm-reg-lname">Last Name <span>*</span></label>
										<input type="text" id="lname" name="lname" placeholder="Last name*">

									</fieldset>
									<fieldset class="wrap-input">
										<label for="frm-reg-email">Email Address<span>*</span></label>
										<input type="text" id="email" name="email" placeholder="Email address">

									</fieldset>
									<fieldset class="wrap-input">
										<label for="frm-reg-email">Tel<span>*</span></label>
										<input type="text" id="tel" name="tel" placeholder="Tel number">
									...
									<fieldset class="wrap-input item-width-in-half left-item ">
										<label for="frm-reg-pass">Password <span>*</span></label>
										<input type="text" id="pass" name="passw" placeholder="Password">

									</fieldset>
									<fieldset class="wrap-input item-width-in-half ">
										<label for="frm-reg-cfpass">Confirm Password <span>*</span></label>
										<input type="text" id="cfpass" name="confpass" placeholder="Confirm Password">
									</fieldset>
					...
					<div class="coppy-right-item item-right">
						<div class="wrap-nav horizontal-nav">
							<ul>
								...
								<li class="menu-item"><a href="terms-conditions.php" class="link-term">Terms & Conditions</a></li>
